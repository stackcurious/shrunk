...
- [ ] Whole-app review (Opus) → fixes → build 2.0.0 (3) → TestFlight (oakley801)
- [ ] Upload six 6.9" shots + paywall shot to ASC (app + both subscriptions)
- [ ] Curated catalogue re-verified from real sources (fabricated data found 2026-08-27); regenerate marketing cases.ts; fix "35" copy
