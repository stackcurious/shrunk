...
| User Content → **Photos or Videos** | A label photo, uploaded to our server with every contribution; stored in a private review queue until a human accepts or rejects it, then deleted | App Functionality | **No** | **No** |
